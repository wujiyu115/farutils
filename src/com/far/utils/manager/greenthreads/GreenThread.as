...
package  com.far.utils.manager.greenthreads {
	...
	public class GreenThread extends EventDispatcher {
		...
		public function GreenThread(stage:Stage, debug : Boolean = true ) {
			_debug = debug;
		}
		
		public final function start( share : Number = 0.99 ) : void {
			_share=share;
			ThreadProcessor.getInstance(_stage,share).addThread( this );
			if( debug ) {
		...
		public final function stop() : void {
			ThreadProcessor.getInstance(_stage,_share).stop( this );
		}
