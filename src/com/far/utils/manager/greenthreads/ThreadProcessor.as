 ...
 */
package com.far.utils.manager.greenthreads
{
	...
	public class ThreadProcessor
	{
		...
		public function ThreadProcessor( stage:Stage,share:Number=0.99)
		{
			if (!_instance)
			{
				_stage=stage;
		...
		public static function getInstance(stage:Stage,share:Number=0.99):ThreadProcessor
		{
			if (!_instance)
			{
				_instance=new ThreadProcessor(stage,share);
			}
			return _instance;
		}
		...
		{
			_stage.addEventListener(Event.ENTER_FRAME, doCycle);
		}
		...
		{
			activeThreads=null;
			_stage.removeEventListener(Event.ENTER_FRAME, doCycle);
		}
